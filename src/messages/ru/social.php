...
return  [
    ...
    '[{socialName}]Response not correct. Code E{statusCode}' => '[{socialName}]Ответ не корректный. E{statusCode}',
    'Random value does not match' => "Рандомное значение не совпадает",
    'Сlient request is incorrect' => 'Запрос клиента неверный',
];